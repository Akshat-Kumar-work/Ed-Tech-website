  ...
  return (
    <div className=' grid mx-auto grid-cols-1 lg:grid-cols-4 mb-10 p-5 lg:w-fit'>
    {
        LearningGridArray.map( ( card, index)=>{
            return (
                <div key={index} className={`${index===0 && "lg:col-span-2 lg:h-[280px] p-5 bg-richblack-900"}
                ...
                
                {
                    ...
                    <div className=' w-fit'>  <CTAbutton active={true} linkto={card.BtnLink}>Learn More</CTAbutton></div>
                     </div>
